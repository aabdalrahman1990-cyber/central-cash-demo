            ...
            <div className="max-w-2xl space-y-6">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                {[
                  {
                    icon: ShieldCheck,
                    title: dict.login.heroCards[0].title,
                    value: dict.login.heroCards[0].value
                  },
                  {
                    icon: Fingerprint,
                    title: dict.login.heroCards[1].title,
                    value: dict.login.heroCards[1].value
                  },
                  {
                    icon: Building2,
                    title: dict.login.heroCards[2].title,
                    value: dict.login.heroCards[2].value
                  }
                ].map((item) => (
